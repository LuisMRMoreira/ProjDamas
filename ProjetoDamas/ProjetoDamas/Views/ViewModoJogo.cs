...
namespace ProjetoDamas
{
    public partial class ViewModoJogo : Form
    {
        ...
        public event MetodosComUmUserEUMJogador PedidoComecarJogoRobot;
        ...
        private void lPlayGame_Click(object sender, EventArgs e)
        {
            ...
            {
                this.Hide();
                if (PedidoComecarJogoRobot != null)
                {
                    PedidoComecarJogoRobot(Program.M_User.Users[0], new Robot(false, false));
                }
            }
            else
            {
