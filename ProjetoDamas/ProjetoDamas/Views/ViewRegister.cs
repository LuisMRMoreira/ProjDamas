        ...
        private void bCreateAccount_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (this.cTBConfirmPass.Text == this.cTBPassword.Text)
                {
                    ...
                    {
                        PedidoRegistarJogador(this.ctBUsername.Text, this.cTBPassword.Text, this.cTBNickname.Text, this.cTBEmail.Text, this.cBCountries.Text, this.pBAvatar.ImageLocation, this.dTPDataNascimento.Value);
                    }
                }
                else
                {
